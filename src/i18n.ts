...
export const messages = {
  zh: {
    ...
    map: {
      ...
      legendA: '當代文化實驗場',
      hint:
        '場館位置請參考地圖。預設內嵌 Google 地圖；可設定環境變數 VITE_GOOGLE_MAPS_API_KEY 以啟用進階地圖。',
    },
    works: {
      title: '作品介紹',
      ...
      /** 每張卡片：image 可為 URL 或 public 路徑（例：'/works/foo.jpg'） */
      cards: [
        {
          title: '濕地迴聲',
          image: '',
          body: '以水面與聲學採樣重塑濕地感知，引導觀眾在暗室中聽見地景的微弱回聲與節奏。',
        },
        {
          title: '頻移',
          image: '',
          body: '透過即時訊號與空間回授，讓「聽見的頻率」隨身體移動而偏移，探測城市中的不可見頻譜。',
        },
        {
          title: '天井之下',
          image: '',
          body: '藉由光影與拾得物構築一方垂直天井，召喚建築縫隙裡的時間與風向。',
        },
        {
          title: '天井之下',
          image: '',
  ...
  en: {
    ...
    map: {
      ...
      hint:
        'Venue location at the Taiwan Contemporary Culture Lab (C-LAB). Embedded Google Maps by default (no API key). Set VITE_GOOGLE_MAPS_API_KEY for a programmable JS map.',
    },
    works: {
      ...
      cards: [
        {
          title: 'Wetland Echo',
          image: '',
          body: 'Water and acoustic sampling reshape wetland perception—listeners catch faint echoes and rhythms in a dimmed room.',
        },
        {
          title: 'Frequency Shift',
          image: '',
          body: 'Live signals and spatial feedback shift what you hear as you move, probing invisible spectra in the city.',
        },
        {
          title: 'Below the Patio',
          image: '',
          body: 'Light, shadow, and found objects sketch a vertical patio—air and time caught in architectural seams.',
        },
        {
          title: 'Below the Patio',
          image: '',
    ...
    footer: {
      ...
      copy: '© 2026 Creative Expo Taiwan',
    },
    langSwitch: 'Language',
  },
