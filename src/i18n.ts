...
8月期間，將呈現歷年精彩穹頂影像作品，以及邀請加拿大 SAT 科技藝術中心「SAT Fest 2026」獲獎作品來臺進行首場國際展映；另規劃現場LIVE演出，開啟跨越感知維度的穹頂體驗。`,
    ...
    credits: {
      ...
      artists: {
        role: '參與藝術家',
        names:
          '王新仁、江戶未來世、加布里耶拉．比拉、初未來、吳秉聖、吳克軍、李宸安、拉爾夫．基爾赫茲、亞歷山大．羅伊、阿嘉塔．史塔舒克、洗筱然、林強、姚瑞中、浮點設計、莊禾、張簡長倫、創意星球、葉澈、莉迪亞．雅科諾夫斯基、超維度、郭一、傑瑞米．格里福、霍爾格．普朗、劉承杰、盧德昕、蕭禹琦、陳蘇楊、賴皮、謝鎮璘、鄭乃銓、魏廷宇、托特．蒂爾．馬爾滕、Kivi、MONOCOLOR、Meuko! Meuko!、Fantastik Obsolete、Ribs+Seixas',
      },
      orgs: [
